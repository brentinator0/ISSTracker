...
//  ISSTracker
//
//  Created by Brent Piephoff on 12/28/18.
...
@objc public protocol GrowingTextViewDelegate: UITextViewDelegate {
    @objc optional func textViewDidChangeHeight(_ textView: ChatInputTextView, height: CGFloat)
}

@IBDesignable @objc
open class ChatInputTextView: UITextView {
    ...
    @objc func textDidEndEditing(notification: Notification) {
        if let sender = notification.object as? ChatInputTextView, sender == self {
